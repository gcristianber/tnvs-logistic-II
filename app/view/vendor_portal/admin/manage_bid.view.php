          ...
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-md-4 grid-margin">
                <img src="https://via.placeholder.com/700x400" class="ht-250 w-100 rounded-2" alt="">
                <div class="mt-4">
                  <p class="fs-3 fw-bold text-uppercase">Intel i5 Computers</p>
                </div>
                <div class="mt-2">
                  <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Temporibus, excepturi? Aliquid hic doloremque dignissimos.</p>
                  <br>
                  <p>
                    Sint aperiam magnam molestiae laudantium quidem, aut quaerat earum asperiores eos rerum incidunt explicabo aliquid necessitatibus, nulla expedita tempore nobis ea. Quae laborum sunt consequatur porro alias. Nam illum, asperiores nemo totam sapiente ex magni unde!
                  </p>
                </div>
                <div class="mt-4">
                ...
                <div class="row">
                  <div class="col-12 text-end">
                    ...
                    <button class="btn btn-danger btn-icon-text">
                      <i data-feather="stop-circle" class="btn-icon-prepend"></i>
                      End Session
                    </button>
                  </div>
                </div>
                  ...
                  <table id="request_tbl" class="table display">
                    ...
                    <tbody>
                      <tr class="align-middle">
                        ...
                        <td>
                          <p>10 Apr 2023</p>
                          <small class="text-muted">09:17 PM</small>
                        </td>
                        <td>
                          <button class="btn btn-primary btn-icon-text">
