          ...
          <div class="card-body">
            ...
            <div class="mb-3 d-flex align-items-center justify-content-between">
              <div>
                ...
                <small class="text-muted">Manage your purchase requests.</small>
              </div>
            </div>
            <ul class="nav nav-tabs nav-tabs-line" id="lineTab" role="tablist">
              ...
              <li class="nav-item">
                <a class="nav-link" id="published-line-tab" data-bs-toggle="tab" href="#published" role="tab" aria-controls="published" aria-selected="false">Published</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" id="ended-line-tab" data-bs-toggle="tab" href="#ended" role="tab" aria-controls="ended" aria-selected="false">Ended</a>
              </li>
              <li class="nav-item">
            ...
            <div class="tab-content mt-3" id="lineTabContent">
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="d-flex align-items-center">
                            <img src="https://via.placeholder.com/40x40" class="ht-40 wd-40 rounded-circle me-2" alt="">
                            <div>
                              <p>John Doe</p>
                        ...
                        <td>
                          ...
                          <small class="text-muted">04:37 AM</small>
                        </td>
                        <td>
                          <p class="fw-bold">03 Jan 2023</p>
                          <small class="text-muted">04:37 AM</small>
              ...
              <div class="tab-pane fade" id="published" role="tabpanel" aria-labelledby="published-line-tab">
                <div class="table-responsive">
                  <table id="PublishedTable" class="table display">
                    <thead>
                      <tr>
                        <th>Purchase Request Id</th>
                        <th>Title</th>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <button class="btn btn-outline-primary btn-icon-text">
                            <i data-feather="sliders" class="btn-icon-prepend"></i>
                            Manage
                          </button>
                        </td>
                      </tr>
              ...
              <div class="tab-pane fade" id="ended" role="tabpanel" aria-labelledby="ended-line-tab">
                <div class="table-responsive">
                  <table id="EndedTable" class="table display">
                    <thead>
                      <tr>
                        <th>Purchase Request Id</th>
                        <th>Title</th>
