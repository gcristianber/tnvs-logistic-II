          ...
          <div class="col-md-6 grid-margin">
            <div class="card">
              <div class="card-body">
                <div class="d-flex align-items-center justify-content-between">
                  <div class="d-flex align-items-center gap-2">
                    ...
                    <div>
                      ...
                      <small class="text-muted">Procurement Specialist</small>
                    </div>
                  </div>
                  <div>
                ...
                <div class="py-3">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Eos quidem rem et similique earum ipsa labore magnam consequatur alias inventore. Aut possimus, quos dolore eos in maiores omnis sunt veniam.
                </div>
                <div>
                  <img src="<?= ROOT ?>assets/images/thumbnails/test-thumbnail.jpg" class="img-fluid rounded-2" alt="">
                </div>
                <div class="d-flex align-items-center gap-1 mt-3 mb-2  text-success">
                ...
                <div>
                  <div class="d-flex align-items-center gap-2">
                    <p>Intel i5 Computers</p><span class="badge border border-primary text-primary">Live</span>
                  </div>
