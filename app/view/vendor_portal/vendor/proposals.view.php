      ...
      <div class="page-content">
        ...
        <div class="row">
          <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                <h6 class="card-title">Invites</h6>
                ...
                <ul class="nav nav-tabs nav-tabs-line" id="lineTab" role="tablist">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" id="contact-line-tab" data-bs-toggle="tab" href="#contact" role="tab" aria-controls="contact" aria-selected="false">Accepted</a>
                  </li>
                          ...
                          <tr class="align-middle">
                            <td>
                              <div class="d-flex align-items-center">
                                <i class="icon-lg me-2" data-feather="hash"></i>
