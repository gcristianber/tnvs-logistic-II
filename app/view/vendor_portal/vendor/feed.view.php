...
<body>
  <div class="main-wrapper">
                    ...
                    <div class="card-body">
                      <div id="postHeader">
                        ...
                        <div class="d-block d-md-flex align-items-center justify-content-between">
                          ...
                          <div class="d-flex align-items-center">
                            <button class="btn btn-primary btn-icon-text me-md-2 w-100" data-bs-toggle="modal" data-bs-target="#sendProposal-<?= $post->post_id ?>">
                              <i class="btn-icon-prepend" data-feather="send"></i>
                              Send Proposal
                            </button>

                            <div class="modal fade" id="sendProposal-<?= $post->post_id ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                              <div class="modal-dialog modal-xl">
                                <div class="modal-content">
                                  ...
                                  <form id="vendorSubmit" data-target="<?= $post->post_id ?>" enctype="multipart/form-data">
    ...
    <script>
        ...
        $('#vendorSubmit').submit((e)=>{
          e.preventDefault()

          var form = document.getElementById("vendorSubmit")
