    ...
    <div class="page-wrapper">
      ...
      <div class="page-content">
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#">Edit Document</a></li>
        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="mb-3">
              <h6>EDIT DOCUMENT</h6>
              <small class="text-muted">Change details of your document.</small>
            </div>
            <div class="row">
              <div class="col-md-12 grid-margin">
                <input type="text" class="form-control mb-3" name="" id="" value="" disabled>
                <div>
              ...
              <ul class="list-group">
                <li class="list-group-item d-flex align-items-center justify-content-between">
                  <div class="d-flex align-items-center">
                    ...
                    <div>
                      <p class="fw-bold">Document.docx</p>
