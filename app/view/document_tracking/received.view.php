    ...
    <div class="page-wrapper">
      ...
      <div class="row">
          <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                <h6 class="card-title">RECEIVED REQUEST</h6>
                ...
                <div class="table-responsive">
                  <table id="dataTableExample" class="table">
                    ...
                    <tbody>
                      ...
                      foreach($received_requests as $item):
                      ?>
                      <tr class="align-middle">
                        ...
                        <td>
                          <div class="d-flex align-items-center">
                            <i class="icon-lg me-2 text-primary" data-feather="folder" fill="currentColor"></i>
                            <div>
                        ...
                        <td>
                          <?php
                          if($item->request_status_name == "pending"){
                            echo
                            '
                            <span class="badge bg-warning">Pending</span>
                            ';
                          }
                          if($item->request_status_name == "endorsed"){
                            echo
                            '
                            <span class="badge bg-secondary">Endorsed</span>
                            ';
                          }
                          if($item->request_status_name == "declined"){
                            echo
                            '
                        ...
                        <td>
                          <button class="btn btn-primary btn-icon-text" data-bs-toggle="modal" data-bs-target="#<?=$item->control_number?>">
                            <i class="btn-icon-prepend" data-feather="maximize-2"></i>
                            Open Request
                          </button>

                          <div class="modal fade" id="<?=$item->control_number?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg modal-dialog-centered">
                              <div class="modal-content">
                                <div class="modal-header">
                                  <h5 class="modal-title" id="exampleModalLabel">Modal titlesss</h5>
                                ...
                                <div class="modal-body">
                                  <div class="d-flex align-items-center justify-content-between mb-3">
                                    ...
                                    <div class="">
                                      <p>04 January 2023</p>
                                      <small class="text-muted">02:38PM</small>
                                    </div>
                                  </div>
                                  ...
                                  if($item->access_type == 0){
                                    ...
                                    <div class="d-flex align-items-center">
                                    <div class="p-3">
                                      <i class="icon-md" data-feather="edit-2"></i>
                                    </div>
                                    <div>
                                      <p>As a Viewer</p>
                                      <small class="text-muted">
                                        Viewers can view or download.
                                      </small>
                                      </div>
                                    </div>
                                    ';
                          ...
                          <div class="dropdown-menu" aria-labelledby="dropdownMenuButton7">
                            ...
                            <a class="dropdown-item d-flex align-items-center" href="<?= ROOT ?>document_tracking/received?id=<?=$item->control_number?>&is_endorsed=true"><i data-feather="check" class="icon-sm me-2"></i> <span class="">Endorse</span></a>
