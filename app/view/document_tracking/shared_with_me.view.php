      ...
      <div class="page-content">
        ...
        <div class="row">
          <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                <h6 class="card-title">SHARED WITH ME</h6>
                ...
                <div class="table-responsive">
                  <table id="dataTableExample" class="table">
                    ...
                    <tbody>
                      <?php
                      if(!empty($shared_with_me)):
                      foreach($shared_with_me as $item):
                      ?>
                      <tr class="align-middle">
                        ...
                        <td>
                          <span class="badge bg-primary"><?=ucwords($item->document_type_name)?></span>
                        </td>
                        <td>
                          <div class="d-flex align-items-center">
                            ...
                            <div>
                              ...
                              <small class="text-muted">69 files</small>
                            </div>
                          </div>
                        </td>
                        <td>
                        ...
                        <td>
                          <div class="text-success">
                            ...
                            <small class="text-muted"><?= date("h:i A", strtotime($item->start_date)) ?></small>
                          </div>
                        </td>
                        <td>
                          <div class="text-danger">
                            <p><?= date("d M Y", strtotime($item->end_date)) ?></p>
                            <small class="text-muted"><?= date("h:i A", strtotime($item->end_date)) ?></small>
                          </div>
                        </td>
                        <td>
                        <?php
                        ...
                        <td>
                          ...
                          if($item->access_type == 0):
                          ?>
                          <a class="btn btn-primary btn-icon-text" href="<?= ROOT ?>document_tracking/shared_with_me/view_file/<?= $item->document_id ?>">
                          ...
                          if($item->access_type == 1):
                          ?>
                          <a class="btn btn-primary btn-icon-text" href="<?= ROOT ?>document_tracking/shared_with_me/edit_file/<?= $item->document_id ?>">
                            <i class="btn-icon-prepend" data-feather="maximize-2"></i>
                            Open Document
                          </a>
                          <?php
