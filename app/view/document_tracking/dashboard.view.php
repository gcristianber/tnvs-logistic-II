      ...
      <div class="page-content">
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      ...
                      <div>
                        <div class="d-flex">
                          <i class="icon-md me-2 text-success" data-feather="search"></i>
                          <h6>ENDORSED</h6>
                        </div>
                        <small class="text-muted">Lorem ipsum dolor sit amet.</small>
                      </div>
        ...
        <div class="row">
          <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                <h6 class="card-title">RECENT REQUEST</h6>
                ...
                <div class="table-responsive">
                  <table id="dataTableExample" class="table">
                    ...
                    <tbody>
                      ...
                      <?php
                      if (!empty($recent_received)) :
                        foreach ($recent_received as $item) :
                      ?>
                          ...
                          <tr class="align-middle">
                            <td>
                              <div class="d-flex align-items-center">
                                ...
                                <div>
                                  <p><?= ucwords($item->accessor_name) ?></p>
                                  <small class="text-muted"><?= ucwords($item->accessor_role) ?></small>
                                </div>
                              </div>
                            </td>
                            <td>
                            ...
                            <td>
                              <div class="d-flex align-items-center">
                                <i class="icon-lg me-2" color="<?= $item->folder_color ?>" data-feather="folder" fill="currentColor"></i>
                                <div>
                                  <p><?= ucwords($item->folder_name) ?></p>
                                </div>
                              </div>
                            </td>
                            <td>
                            ...
                            <td>
                              <div class="d-flex align-items-center">
                                ...
                                if ($item->is_editor === 1) {
                                  echo
                                  '
                              <i class="icon-md me-2" data-feather="edit-2"></i>
                              <p>Editor</p>
                              ';
                                }
                                if ($item->is_viewer === 1) {
                                  echo
                                  '
                              <i class="icon-md me-2" data-feather="eye"></i>
                              <p>Viewer</p>
                              ';
                                }
                                ?>
                            ...
                            <td>
                              <button class="btn btn-primary btn-icon-text" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                <i class="btn-icon-prepend" data-feather="maximize-2"></i>
                                Open Request
                              </button>
                                  ...
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                      <div class="d-flex align-items-center justify-content-between mb-3">
                                        ...
                                        <div class="">
                                          <p>04 January 2023</p>
                                          <small class="text-muted">02:38 PM</small>
                                        </div>
                                      </div>
                                      <div class="p-3 bg-gray-100 rounded-2 text-wrap mb-3">
                                        <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Illum officia debitis voluptate aliquid. Hic eaque sapiente neque accusantium laudantium aperiam consectetur suscipit mollitia enim iste!</p>
                                      </div>
                                      <div class="d-flex align-items-center">
                                        <div class="p-3">
                                          <i class="icon-md me-2" data-feather="edit-2"></i>
                                        ...
                                        <div>
                                          <div>
                                            <p>As an Editor</p>
                                            <small class="text-muted">Editor can directly edit document.</small>
                                          </div>
                                        </div>
                                      </div>
                              ...
                              <div class="dropdown-menu" aria-labelledby="dropdownMenuButton7">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="javascript:;"><i data-feather="check" class="icon-sm me-2"></i> <span class="">Grant</span></a>
                                <a class="dropdown-item d-flex align-items-center" href="javascript:;"><i data-feather="trash" class="icon-sm me-2"></i> <span class="">Refuse</span></a>
                                <a class="dropdown-item d-flex align-items-center" href="javascript:;"><i data-feather="slash" class="icon-sm me-2"></i> <span class="">Black list</span></a>
                              </div>
                            </td>
                          </tr>
        ...
        <div class="row">
          <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                <h6 class="card-title">Folders</h6>
                <p class="text-muted mb-3">Read the <a href="https://datatables.net/" target="_blank"> Official DataTables Documentation </a>for a full list of instructions and other options.</p>
                <div class="table-responsive">
                  <table id="dataTableExample" class="table">
                    <thead>
                    ...
                    <tbody>
                      ...
                      ?>
                          <tr class="align-middle">
                            <td>
                              <div class="d-flex align-items-center">
                                <i class="me-2" color="<?= $item->folder_color ?>" fill="currentColor" data-feather="folder"></i>
                                <div>
                                  <p><?= ucwords($item->folder_name) ?></p>
                                </div>
                              </div>
                            ...
                            <td>
                              <p><?= ucwords($item->department_name) ?></p>
                            </td>
                            <td>
                              <div class="d-flex align-items-center">
                                <img class="ht-40 wd-40 rounded-circle me-2" src="https://via.placeholder.com/40x40" alt="">
                                <div>
                                  ...
                                  <small class="text-muted"><?= ucwords($item->role) ?></small>
                                </div>
                              </div>
                            </td>
                            <td>
                            ...
                            <td>
                              <a href="<?= ROOT ?>document_tracking/folder/<?= $item->folder_id ?>"><i class="icon-md" data-feather="chevron-right"></i></a>
                            </td>
                          </tr>
                      <?php
                        endforeach;
