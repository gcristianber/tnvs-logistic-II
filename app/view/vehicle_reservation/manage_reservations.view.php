        ...
        <div class="card">
          <div class="card-body">
            ...
            <ul class="nav nav-tabs nav-tabs-line" id="lineTab" role="tablist">
              ...
              <li class="nav-item">
                <a class="nav-link" id="dispatched-line-tab" data-bs-toggle="tab" href="#dispatched" role="tab" aria-controls="dispatched" aria-selected="false">Dispatched</a>
              </li>
              <li class="nav-item">
            ...
            <div class="tab-content mt-3" id="lineTabContent">
              ...
              <div class="tab-pane fade" id="reserved" role="tabpanel" aria-labelledby="reserved-line-tab">
                <div class="table-responsive">
                  <table id="dataTableExample" class="table display">
                    <thead>
                      <tr>
              ...
              <div class="tab-pane fade" id="dispatched" role="tabpanel" aria-labelledby="dispatched-line-tab">
                <div class="table-responsive">
                  <table id="dataTableExample" class="table display">
                    <thead>
                      <tr>
