...
<head>
	...
	<link rel="stylesheet" href="<?= ROOT ?>assets/vendors/tempusdominus-bootstrap-4/tempusdominus-bootstrap-4.min.css">
...
<body>
						...
						<div class="modal-content">
							...
							<div id="modalBody2" class="modal-body">
								<form id="testForm">
									...
									<div class="mb-3">
										<label for="datetimepickerExample" class="form-label">Time</label>
										<div class="input-group date timepicker" id="datetimepickerExample" data-target-input="nearest">
											<input type="text" name="time_schedule" class="form-control datetimepicker-input" data-target="#datetimepickerExample" />
									...
									<div class="mb-3">
										...
										<textarea class="form-control" name="description" id="description" cols="30" rows="3" placeholder="Type something..."></textarea>
									</div>

							</div>
							<div class="modal-footer">
								<button type="button" class="btn btn-default" data-bs-dismiss="modal">Close</button>
								<button type="submit" class="btn btn-primary" id="sendSchedule">Add Schedule</button>
							</div>
							</form>
						</div>
					</div>
	...
	<script src="<?= ROOT ?>assets/custom/js/set-schedule-calendar.js"></script>
	<script src="<?= ROOT ?>assets/js/timepicker.js"></script>
