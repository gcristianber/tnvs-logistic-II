...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 13, 2023 at 12:02 PM
...
('10178508271', 2, 1, '', 'ananana', '0000-00-00 00:00:00', NULL, 'sa12345', 4),
...
('23408849606', 2, 1, '', 'test', '0000-00-00 00:00:00', NULL, 'sa12345', 4),
('24073973067', 3, 2, '', 'Requesting document', '0000-00-00 00:00:00', NULL, 'sa12345', 4),
('30338669218', 2, 3, '', 'hdhdhdhd', '0000-00-00 00:00:00', NULL, 'sa12345', 1),
('34199959534', 3, 1, '', 'hahhaha', '0000-00-00 00:00:00', NULL, 'sa12345', 1),
('36304390778', 1, 1, '', 'hey', '0000-00-00 00:00:00', NULL, 'sa12345', 4),
...
('52102021953', 3, 1, '', 'request', '0000-00-00 00:00:00', NULL, 'sa12345', 4),
('56670429052', 2, 1, '', 'TEST', '0000-00-00 00:00:00', NULL, 'sa12345', 4),
('58053381101', 3, 3, '', 'haha', '0000-00-00 00:00:00', NULL, 'sa12345', 1),
('5863221867', 2, 3, '', 'hahahahah', '0000-00-00 00:00:00', NULL, 'sa12345', 4),
...
('82040645889', 3, 2, '', 'wew', '0000-00-00 00:00:00', NULL, 'sa12345', 4),
...
('91928192642', 2, 3, '', 'test par', '0000-00-00 00:00:00', NULL, 'sa12345', 3),
...
--
-- Stand-in structure for view `log2_dt_templates_view`
-- (See below for the actual view)
--
...
('5863221867', '2023-03-13 11:29:05', 4, NULL),
('52102021953', '2023-03-13 11:32:56', 4, NULL),
('23408849606', '2023-03-13 11:33:19', 3, 'haha'),
('23408849606', '2023-03-13 11:33:28', 3, NULL),
('36304390778', '2023-03-13 15:11:57', 1, NULL),
('36304390778', '2023-03-13 15:12:45', 2, 'test1'),
('36304390778', '2023-03-13 15:13:23', 3, NULL),
('23408849606', '2023-03-13 15:14:46', 3, NULL),
('24073973067', '2023-03-13 15:16:06', 3, NULL),
('56670429052', '2023-03-13 15:18:23', 3, ''),
('82040645889', '2023-03-13 15:23:56', 3, 'test'),
('23408849606', '2023-03-13 15:24:57', 3, NULL),
('91928192642', '2023-03-13 15:25:42', 3, 'test'),
('10178508271', '2023-03-13 15:28:20', 2, 'test'),
('10178508271', '2023-03-13 15:28:30', 3, 'yay'),
('10178508271', '2023-03-13 15:28:44', 4, NULL),
('23408849606', '2023-03-13 15:30:38', 4, 'hahahaha'),
('24073973067', '2023-03-13 15:31:47', 4, 'test'),
('36304390778', '2023-03-13 15:32:47', 4, 'hahaha'),
('56670429052', '2023-03-13 15:34:20', 4, 'hahahahaha'),
('82040645889', '2023-03-13 15:35:06', 4, 'low');
...
('rsv640edf1edc40a', 'vh6406da084a6fc', 'sa12345', 'gcristianber@gmail.com', '123', 'test', '03/13/2023', '03/13/2023', 4),
('rsv640ef16bb3d5a', 'vh6406da084a6fc', 'sa12345', 'gcristianber@gmail.om', '09240914124', 'tst', '03/14/2023', '03/13/2023', 4);
...
--
-- Structure for view `log2_dt_templates_view`
--
DROP TABLE IF EXISTS `log2_dt_templates_view`;

CREATE VIEW `log2_dt_templates_view`  AS SELECT `log2_dt_templates`.`template_id` AS `template_id`, `log2_dt_templates`.`description` AS `description`, `log2_dt_templates`.`is_enabled` AS `is_enabled`, `log2_dt_templates`.`content` AS `content`, `log2_dt_templates`.`date_created` AS `date_created`, `admin_dm_category`.`category_name` AS `category_name` FROM (`log2_dt_templates` left join `admin_dm_category` on(`log2_dt_templates`.`category_id` = `admin_dm_category`.`category_id`))  ;
...
--
-- Indexes for table `log2_dt_templates`
--
ALTER TABLE `log2_dt_templates`
  ADD PRIMARY KEY (`template_id`),
  ADD KEY `FK_dt_templates` (`category_id`);
...
--
-- Constraints for table `log2_dt_templates`
--
ALTER TABLE `log2_dt_templates`
  ADD CONSTRAINT `FK_dt_templates` FOREIGN KEY (`category_id`) REFERENCES `admin_dm_category` (`category_id`);
